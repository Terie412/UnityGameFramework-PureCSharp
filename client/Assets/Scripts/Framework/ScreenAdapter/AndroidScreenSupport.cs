...
public class AndroidScreenSupport : SingleTon<AndroidScreenSupport>
{
    ...
    private AndroidPhoneType m_CurAndroidPhoneType = AndroidPhoneType.MAX;
    ...
    private float m_SafeAreaEdge = -1;
    public bool isSafeAreaSupported
    {
        get
        {
            m_IsSafeAreaSupported = HasSafeArea(out m_SafeAreaEdge);
            return m_IsSafeAreaSupported;
        }
    }
    public float safeAreEdge
    {
        get
        {
            m_IsSafeAreaSupported = HasSafeArea(out m_SafeAreaEdge);
            return m_SafeAreaEdge;
        }
    }
    ...
    public bool HasSafeArea(out float edge)
    {
        ...
        {
            m_IsSafeAreaSupported = HasSafeArea_AndroidP(out edge);
            m_SafeAreaEdge = edge;
        ...
        {
            AndroidPhoneType.XIAOMI => HasSafeArea_XIAOMI(out edge),
            AndroidPhoneType.HUAWEI => HasSafeArea_Huawei(out edge),
            AndroidPhoneType.VIVO => HasSafeArea_Vivo(out edge),
            AndroidPhoneType.OPPO => HasSafeArea_Oppo(out edge),
            AndroidPhoneType.SAMSUNG => HasSafeArea_Samsung(out edge),
            _ => m_IsSafeAreaSupported
        };

        if (!m_IsSafeAreaSupported)
        {
            m_IsSafeAreaSupported = HasSafeArea_Notch(out edge);
        }
    ...
    private bool HasSafeArea_AndroidP(out float edge)
    {
        edge = 0;
    ...
    private bool HasSafeArea_XIAOMI(out float edge)
    {
        edge = 0;
    ...
    private bool HasSafeArea_Huawei(out float edge)
    {
        edge = 0;
        try
        {
    ...
    private bool HasSafeArea_Vivo(out float edge)
    {
        edge = 0;
        try
        {
    ...
    private bool HasSafeArea_Oppo(out float edge)
    {
        edge = 0;
    ...
    private bool HasSafeArea_Samsung(out float edge)
    {
        edge = 0;
    ...
    /// <returns></returns>
    private bool HasSafeArea_Notch(out float edge)
    {
        edge = 0;
