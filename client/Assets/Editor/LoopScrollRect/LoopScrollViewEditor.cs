...
namespace UnityEditor.UI
{
    ...
    public class LoopScrollRectEditor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)LoopScrollRect.MovementType.Elastic, instant);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((LoopScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == LoopScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((LoopScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == LoopScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
